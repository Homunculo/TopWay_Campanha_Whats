...
class WhatsApp:
    ...
    def __init__(self, wait, screenshot=None, session=None):
        ...
        if session:
            ...
            self.browser = webdriver.Chrome('Simple-Yet-Hackable-WhatsApp-api-master/chromedriver.exe', options=chrome_options)  # we are using chrome as our webbrowser
        else:
            self.browser = webdriver.Chrome('Simple-Yet-Hackable-WhatsApp-api-master/chromedriver.exe')
        self.browser.get("https://web.whatsapp.com/")
        # emoji.json is a json file which contains all the emojis
        with open("Simple-Yet-Hackable-WhatsApp-api-master/emoji.json") as emojies:
